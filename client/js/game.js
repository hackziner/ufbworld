...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        init: function(app) {
            ...
            // sprites
            this.spriteNames = ["hand", "sword", "loot", "target", "talk", "sparks", "shadow16", "rat", "bee", "skeleton", "skeleton2", "spectre", "boss", "deathknight",
                                "ogre", "crab", "spider", "fluffy", "snake", "eye", "bat", "batyellow", "goblin", "wizard", "guard", "king", "villagegirl", "villager", "coder", "agent", "rick", "scientist", "nyan", "priest",
